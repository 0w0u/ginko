...
module.exports = class DonComediaCommand extends Command {
	constructor(client) {
		super(client, {
			name: 'don-comedia',
			...
			if (message.guild) {
				...
				async function o(m) {
					embed
						...
						.setTitle('Don Comedia')
						.setDescription(
							(m !== message.member
								? `El nivel de "Don Comedia" de **${m.displayName}**`
								: `Tu nivel de "Don Comedia"`) +
								' es de ' +
								ran +
								'%'
						);
				...
				async function o(m) {
					embed
						...
						.setDescription(
							(m !== message.author
								? `El nivel de "Don Comedia" de **${m.username}**`
								: `Tu nivel de "Don Comedia"`) +
								' es de ' +
								ran +
								'%'
