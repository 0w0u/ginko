    ...
    try {
      if (message.guild) {
        ...
        async function o(m, client) {
          ...
          else if (p && p.web === 'online') status = onlineE.toString() + ' **Conectado**: en **web**';
          else if (p && p.web === 'idle') status = idleE.toString() + ' **Ausente**: en **web**';
          else if (p && p.web === 'dnd') status = dndE.toString() + ' **No molestar**: en **web**';
          else if (p && p.mobile === 'online') status = onlineME.toString() + ' **Conectado**: en **móvil**';
          else if (p && p.mobile === 'idle') status = idleME.toString() + ' **Ausente*:* en **móvil**';
          else if (p && p.mobile === 'dnd') status = dndME.toString() + ' **No molestar**: en **móvil**'
